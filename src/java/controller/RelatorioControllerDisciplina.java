...
public class RelatorioControllerDisciplina extends HttpServlet {
...
private void relatorioSemParametro(HttpServletRequest request, HttpServletResponse response) {
 Connection conexao = null;
        try {
            ...
            String relatorio = getServletContext().getRealPath("/WEB-INF/classes/relatorio")+"/reportDisciplinaSemParamentro.jasper";

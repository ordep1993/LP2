...
public class RelatorioControllerProfessor extends HttpServlet {
...
private void relatorioSemParametro(HttpServletRequest request, HttpServletResponse response) {
 Connection conexao = null;
        try {
           ...
           // parametros.put("P_CODIGO", Integer.parseInt(request.getParameter("txtMatricula")));
            //parametros.put("P_NOME", request.getParameter("txtNome"));
            
            String relatorio = getServletContext().getRealPath("/WEB-INF/classes/relatorio")+"/reportProfessorSemParamentro.jasper";
